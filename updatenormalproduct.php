                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="addtional_information" id="product-additional-information" placeholder="Additional Information" required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Notes</label>
                                            <textarea class="form-control" rows="3" name="addtional_information" id="product-notes" placeholder="Mention Notes to User" required></textarea>
                                            <p class="help-block">Do not mention notes more than 5 lines</p>
                                        </div>
                                         <div class="form-group">
                                            <label>Length</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="subcategory" id="product-sub-category" >
                                                <option> --SELECT OPTION-- </option>
                                            </select>
                                        </div>
                                        <div class="form-group">
