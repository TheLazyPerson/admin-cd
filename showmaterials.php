        ...
        $.ajax({
            ...
            success : function(result) {
                ...
                $.each(data, function (key, value) {
                    ...
                    html += '<tr class="odd "><td>'+ materialName +'</td><td>'+ materialDescription+'</td><td class="center"><a href="updatecategory.php?id='+ materialId +'">Update Material</a></td><td class="center"><a href="deletecategory.php?id='+ materialId +'">Delete</a></td></tr>'; 
                });
